...
public class StructurePlacerUtils {
    ...
    public static void constructSmallOakBarrel(WorldMock worldMock) {
        StairsDataMock stairsDataMock1 = (StairsDataMock) BlockDataMock.mock(Material.SPRUCE_STAIRS);
        ...
        StairsDataMock stairsDataMock2 = (StairsDataMock) BlockDataMock.mock(Material.SPRUCE_STAIRS);
        ...
        StairsDataMock stairsDataMock3 = (StairsDataMock) BlockDataMock.mock(Material.SPRUCE_STAIRS);
        ...
        StairsDataMock stairsDataMock4 = (StairsDataMock) BlockDataMock.mock(Material.SPRUCE_STAIRS);
