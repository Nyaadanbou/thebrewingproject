...
class BrewTest {
    RecipeRegistry<RecipeResult, ItemStack, PotionMeta> registry;
    ...
    void quality_differingDifficulties(int difficulty) {
        Recipe<RecipeResult, ItemStack> recipe = new Recipe.Builder<RecipeResult, ItemStack>("test")
    ...
    void setupRecipes() {
        Recipe<RecipeResult, ItemStack> recipe1 = new Recipe.Builder<RecipeResult, ItemStack>("recipe1")
                .agingYears(13)
                .brewTime(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Recipe<RecipeResult, ItemStack> recipe2 = new Recipe.Builder<RecipeResult, ItemStack>("recipe2")
                .agingYears(13)
                .brewTime(10)
                .barrelType(BarrelType.ACACIA)
                .brewDifficulty(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Recipe<RecipeResult, ItemStack> recipe3 = new Recipe.Builder<RecipeResult, ItemStack>("recipe3")
                .agingYears(13)
                .brewTime(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Recipe<RecipeResult, ItemStack> recipe4 = new Recipe.Builder<RecipeResult, ItemStack>("recipe4")
                .agingYears(13)
                .brewTime(10)
                .barrelType(BarrelType.ACACIA)
                .brewDifficulty(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Recipe<RecipeResult, ItemStack> recipe5 = new Recipe.Builder<RecipeResult, ItemStack>("recipe5")
                .agingYears(13)
                .brewTime(10)
                .barrelType(BarrelType.ACACIA)
                .brewDifficulty(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Recipe<RecipeResult, ItemStack> recipe6 = new Recipe.Builder<RecipeResult, ItemStack>("recipe6")
                .agingYears(13)
                .brewTime(11)
                .barrelType(BarrelType.ACACIA)
                .brewDifficulty(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Recipe<RecipeResult, ItemStack> recipe7 = new Recipe.Builder<RecipeResult, ItemStack>("recipe7")
                .agingYears(10)
                .brewTime(10)
                .barrelType(BarrelType.ACACIA)
                .brewDifficulty(10)
                ...
                .recipeResult(RecipeResult.GENERIC)
                .build();
        Map<String, Recipe<RecipeResult, ItemStack>> recipeMap = new HashMap<>();
